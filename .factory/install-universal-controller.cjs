...
const engineDir = path.join(root, ".factory", "engine");
const reportDir = path.join(root, ".factory", "reports");
...
const report = {
  ...
  capabilities: [
    ...
    "project isolation",
    "package/run/deploy pipeline"
  ]
};

fs.writeFileSync(
  path.join(reportDir, "universal-factory-controller.json"),
...
console.log("");
console.log("==================================================");
console.log(" SIMEONJR UNIVERSAL FACTORY CONTROLLER INSTALLED");
console.log("==================================================");
console.log("Prompt-driven single/multi-app logic: ACTIVE");
console.log("Dynamic SaaS detection: ACTIVE");
console.log("Offline-first architecture: ACTIVE");
console.log("Desktop packaging readiness: ACTIVE");
console.log("Mobile packaging readiness: ACTIVE");
console.log("Hosted deployment readiness: ACTIVE");
console.log("Production pipeline: ACTIVE");
console.log("Checkpoint integration: ACTIVE");
